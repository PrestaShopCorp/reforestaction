...
{if version_compare($smarty.const._PS_VERSION_, '1.6', '<')}
	<a href="{$url_enable}" {if isset($confirm)}onclick="return confirm('{$confirm}');"{/if} title="{if $enabled}{l s='Enabled' mod='reforestaction'}{else}{l s='Disabled' mod='reforestaction'}{/if}">
